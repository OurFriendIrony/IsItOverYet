...
import static uk.co.ourfriendirony.isitoveryet.general.TimeHandler.MILLIS_HOUR;
import static uk.co.ourfriendirony.isitoveryet.general.TimeHandler.getMillisThisHour;
import static uk.co.ourfriendirony.isitoveryet.general.TimeHandler.getNow;

public class ActivityFragmentHour extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        textSub.setText("Hour");
        return rootView;
    }

    private double getElapsedTimeAsPercent() {
        long passed = getNow() - getMillisThisHour();
        return ((double) passed / MILLIS_HOUR) * 100;
    }
